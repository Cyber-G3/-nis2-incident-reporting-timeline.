...
export const tr=value=>Object.prototype.hasOwnProperty.call(ES,value)?ES[value]:value;
...
export function assessIncident(input, now = new Date()) {
  ...
  const authority=Object.prototype.hasOwnProperty.call(AUTHORITIES,input.country)?AUTHORITIES[input.country]:AUTHORITIES.EU;
