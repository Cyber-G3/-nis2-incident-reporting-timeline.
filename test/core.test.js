...
test("safely handles prototype property names in country and tr lookups",()=>{const r=assessIncident({country:"constructor",fields:{}},new Date());assert.match(r.authority.name,/National competent authority/);assert.equal(tr("toString"),"toString")});
