...
test("safely handles prototype property lookups for authority and translation",()=>{const r=assessIncident({country:"toString",fields:{}},new Date());assert.equal(r.authority.name,"National competent authority / CSIRT");assert.equal(tr("toString"),"toString")});
