...
import { assessIncident, addHours, addCalendarMonth, buildMarkdown, tr } from "../core.js";
...
test("tr safely handles prototype property names",()=>{assert.equal(tr("toString"),"toString");assert.equal(tr("constructor"),"constructor")});
test("assessIncident safely falls back to default EU authority on prototype property name",()=>{const r=assessIncident({country:"constructor",fields:{}},new Date());assert.equal(r.authority.name,"National competent authority / CSIRT")});
