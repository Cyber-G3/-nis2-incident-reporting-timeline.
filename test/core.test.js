...
test("escapeHtml escapes dangerous HTML characters",()=>{assert.equal(escapeHtml("<script>alert('xss')&\"</script>"),"&lt;script&gt;alert(&#39;xss&#39;)&amp;&quot;&lt;/script&gt;")});
test("authority lookup prevents prototype key access",()=>{const r=assessIncident({country:"toString",fields:{}},new Date());assert.equal(r.authority.name,"National competent authority / CSIRT")});
