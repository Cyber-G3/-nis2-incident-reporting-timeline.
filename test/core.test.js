...
test("safely handles prototype properties in country selection",()=>{const r=assessIncident({country:"toString",fields:{}},new Date());assert.equal(r.authority.name,"National competent authority / CSIRT")});
