...
test("escapeHtml sanitizes HTML special characters to prevent XSS",()=>{assert.equal(escapeHtml('<script>alert("xss & \'test\'")</script>'),"&lt;script&gt;alert(&quot;xss &amp; &#39;test&#39;&quot;)&lt;/script&gt;");assert.equal(escapeHtml(null),"");assert.equal(escapeHtml(undefined),"");});
