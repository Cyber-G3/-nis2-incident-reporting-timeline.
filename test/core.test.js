...
test("country lookup safely falls back to EU for prototype properties",()=>{const r=assessIncident({country:"constructor",fields:{}},new Date());assert.equal(r.authority.name,"National competent authority / CSIRT")});
